...
const themsModel = require('../db/model/themeModel')
const goodsTypeModel = require('../db/model/goodsTypeModel')
...
router.get("/themelist", (req, res) => {
  ...
  themesModel.aggregate([{
    '$group': {
      '_id': '$type',
      'info': {
        '$push': { imgPath: '$imgPath', name: '$name', size: '$size' }
      }
    }
  }
  ])
